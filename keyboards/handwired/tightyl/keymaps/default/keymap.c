...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT(
        ...
        XXX      , KC_LCTL, KC_LALT, KC_LCTL,       KC_LSFT,    XXX,                    KC_LEFT  , KC_DOWN     , KC_UP   , KC_RIGHT       , XXX             , KC_UNDS,
    ...
    [_FUN] = LAYOUT(
        ...
        KC_TRNS  , KC_LCTL, KC_LALT, KC_LCTL, KC_LSFT     , KC_TRNS,                    KC_F7    , KC_F8       , KC_F9   , KC_F10          , KC_F11          , KC_F12,
    ...
    [_NUM] = LAYOUT(
        ...
        KC_ASTR  , KC_SLSH , KC_4   , KC_5   , KC_6        , KC_LBRC,                   XXX      , KC_LSFT     , KC_LCTL , KC_LALT        , KC_LCTL         ,  XXX,
    ...
    [_SYM] = LAYOUT(
        ...
        KC_PERC  , KC_LPRN , KC_EQL , KC_GT  , KC_LCBR      , KC_LBRC,                    XXX      , KC_LSFT     , KC_LCTL , KC_LALT        , KC_LCTL         ,  XXX,

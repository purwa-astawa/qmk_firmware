...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_DEL   , KC_LGUI, KC_WH_D, KC_WH_U,                                                                                       KC_PGDN , KC_PGUP        , KC_LGUI         , LT(3, KC_DEL),
        C_S_T(KC_BSLS),LSFT_T(KC_TAB), ALT_T(KC_DOWN), CTL_T(KC_UP), KC_SPC, LT(1, KC_SCLN),   LT(2, KC_GRV), LSFT_T(KC_ESC), CTL_T(KC_RIGHT),   ALT_T(KC_ESC), MEH_T(KC_ENT), LCA_T(KC_BSPC)
    ),
    [1] = LAYOUT(
        KC_ESC   , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F12  ,                   KC_F11   , KC_F6    , KC_F7    , KC_F8    , KC_F9   , KC_F10   , KC_BSPC ,
        KC_TAB   , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS   , KC_TRNS ,                   KC_TRNS  , KC_MS_L  , KC_MS_D  , KC_MS_U , KC_MS_R  , KC_TRNS  , KC_BTN1,
        ...
        KC_TRNS  , KC_TRNS, KC_TRNS, KC_TRNS,                                                                              KC_PGDN , KC_PGUP    , KC_END   , KC_NO ,
        KC_TRNS  , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,                                                   KC_NO, KC_TRNS  ,  KC_TRNS,  KC_NO, KC_TRNS ,KC_TRNS
    ),
    [2] = LAYOUT(
        KC_TRNS  , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS ,                   KC_TRNS , KC_TRNS  , KC_TRNS  , KC_TRNS , KC_TRNS , KC_TRNS         , KC_TRNS ,
        KC_TAB   , KC_AT  , KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_TRNS ,                   KC_TRNS , KC_BSLS  , KC_PLUS  , KC_ASTR,  KC_QUOTE, KC_DQT         , KC_TRNS ,
        KC_LALT  , KC_EXLM, KC_LPRN, KC_RPRN, KC_LABK, KC_RABK, KC_TRNS ,                   KC_TRNS , KC_SLSH  , KC_PEQL  , KC_AMPR,  KC_QUES , KC_COLN         , KC_TRNS ,
        KC_LSFT  , KC_NO  , KC_PERC, KC_DLR , KC_CIRC, KC_HASH,                                        KC_PIPE , KC_MINUS , KC_UNDS , KC_TRNS  , KC_TRNS         , KC_TRNS ,

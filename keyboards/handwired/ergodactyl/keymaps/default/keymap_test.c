...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        MO(1)    , KC_9, KC_5, KC_6,                                                                              KC_7 , KC_8         , KC_0          , KC_DEL ,
        C_S_T(KC_DEL),KC_2,KC_LSFT, LSFT_T(KC_SPC), KC_1, KC_LGUI,                       KC_GRV   , KC_4 ,  LSFT_T(KC_ENT),  MEH_T(KC_ESC), KC_3,LCA_T(KC_BSPC)
    ),
    [1] = LAYOUT(
